"""v0.4 Web Demo Server - Local showcase of Budget Guardian and Decision Gate.
...
# Initialize Sidecar with Budget Guardian
        ...
        <div class="grid">
            ...
            <div class="card">
                ...
                <div class="input-group">
                    ...
                    <input type="number" id="cost-input" placeholder="e.g., 2.50" step="0.01" min="0" max="20">
                </div>
            ...
            <div class="card">
                ...
                <div class="input-group">
                    ...
                    <input type="number" id="refund-amount" placeholder="e.g., 300" step="1" min="0" max="2000">
                </div>
            ...
            <div class="card">
                ...
                <div class="decision-outcomes">
                    <div class="outcome-badge implemented">ALLOW</div>
                    <div class="outcome-badge implemented">WARN</div>
                    <div class="outcome-badge implemented">BLOCK</div>
                    <div class="outcome-badge implemented">CHALLENGE</div>
                    <div class="outcome-badge implemented">REPLAN</div>
                    <div class="outcome-badge implemented">PAUSE</div>
                    <div class="outcome-badge implemented">ESCALATE</div>
                </div>

                <div class="info-box">
                    <strong>Current Features:</strong>
                    <ul style="margin-top: 10px; padding-left: 20px;">
                        <li>Budget Guardian (cost/token tracking)</li>
                        <li>Policy Advisor (rules-based blocking)</li>
                        <li>Risk Evaluator (risk classification)</li>
                        <li>Intent Guardian (constraint validation)</li>
                        <li>Full Decision Gate (PAUSE for escalation)</li>
    ...
    <script>
        ...
        function testBudget() {
            ...
            .then(data => {
                ...
                const statusClass = data.decision.status.toLowerCase();
                showResult('budget-result', data.decision, statusClass);
            });
        }
        ...
        function testPolicy() {
            ...
            .then(data => {
                const statusClass = data.decision.status.toLowerCase();
                showResult('policy-result', data.decision, statusClass);
            });
        }
        ...
        function testIntent() {
            ...
            .then(data => {
                const statusClass = data.decision.status.toLowerCase();
                showResult('intent-result', data.decision, statusClass);
            });
        }
...
def api_intent():
    ...
    decision = sidecar_with_intent.evaluate(context)
